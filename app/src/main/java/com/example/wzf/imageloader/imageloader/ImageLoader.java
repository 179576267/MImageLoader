package com.example.wzf.imageloader.imageloader;
...
import com.example.wzf.imageloader.R;
...
public class ImageLoader {
    ...
    private static final int TAG_KEY_URL = R.id.gridView1;

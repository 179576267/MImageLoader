package com.example.wzf.imageloader;
...
import com.example.wzf.imageloader.tools.CommonAdapter;
import com.example.wzf.imageloader.imageloader.ImageLoader;
import com.example.wzf.imageloader.tools.MyUtils;
import com.example.wzf.imageloader.tools.ViewHolder;
    ...
    private void setAdapter() {
        adapter = new CommonAdapter<String>(mUrList, this, R.layout.image_list_item) {
            ...
            public void convert(ViewHolder viewHolder, String item) {
                ...
                final String tag = (String)im.getTag();
                if (!item.equals(tag)) {
                    im.setImageResource(R.mipmap.ic_launcher);
                }
                if (mIsGridViewIdle ) {
                    im.setTag(item);
                    mImageLoader.bindBitmap(item, im, mImageWidth, mImageWidth);
                }
            }
        };
